...
public class WatchedMoviesIntegrationTest {
    ...
    @BeforeEach
    public void setUp() {
        baseUrl = "http://localhost:" + port + "/api/watched-movies";
    }
    ...
    @Test
    public void testRemoveWatchedMovie() {
        var movie = new Movie();
        movie.setTitle("test");
        movie.setMovie_year(2023);
        movie.setCategory("Drama");
...
//    @Test
//    public void testAddAndGetToWatchMovieForKids() {
//        var movie = new Movie();
//        movie.setTitle("test");
//        movie.setMovie_year(2023);
//        movie.setCategory("Drama");
